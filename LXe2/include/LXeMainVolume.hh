...
// * for the full discGlaimer and the limitation of liability.         *
// *                                                                  *
...
//  G4Box* fHousing_box;
  ...
  G4VSolid* BuildPlaSolid(G4double X, G4double Y, G4double Z);
  ...
  G4double Ttape = 1.*mm;
  G4double outerTtape = outerTal+Ttape;//1.*mm;
  G4double Tcanning = 1.*mm;
  G4double outerTcanning = outerTtape+Tcanning;//1.*mm;
  G4double detX = 150*mm;
  G4double detY = 150*mm;
  G4double detZ = 250*mm;
  G4double froundedEdgesRadius  = 10*mm;
