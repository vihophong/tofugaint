...
class LXeDetectorConstruction : public G4VUserDetectorConstruction
{
 public:
  ...
  G4double GetExpHallX() const { return fExpHall_x; }
  G4double GetExpHallY() const { return fExpHall_y; }
  G4double GetExpHallZ() const { return fExpHall_z; }
 ...
 private:
  ...
  G4MaterialPropertiesTable* fLXe_mt2;
